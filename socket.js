...
rl.question("Dame tu correo ", function(correo) {
    rl.question("Clave ", function(clave) {
          request.post({
                ...
                "url": "http://167.71.160.73:8080/api/usuarios/login/",
                "body": JSON.stringify({
                    "correo": correo,
                    "clave": clave
                })
                ...
                if(resultado.length == 1){
                  ...
                  idUsuario = resultado[0]._id;
                  console.log("id del usuario traido",idUsuario);
                  console.log("id del usuario traido",resultado._id);
                  console.log("id del usuario traido",resultado[0]);
